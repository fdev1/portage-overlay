...
SRC_URI="
	x86? ( https://az764295.vo.msecnd.net/public/${PV}/VSCode-linux32.zip -> VSCode-linux-ia32-${PV}.zip )
	amd64? ( https://az764295.vo.msecnd.net/public/${PV}/VSCode-linux64.zip -> VSCode-linux-x64-${PV}.zip )"
RESTRICT="mirror"
