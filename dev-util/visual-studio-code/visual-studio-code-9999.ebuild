...
SRC_URI="
	x86? ( https://vscode-update.azurewebsites.net/latest/linux-ia32/stable -> VSCode-linux-ia32-${PV}.zip )
	amd64? ( https://vscode-update.azurewebsites.net/latest/linux-x64/stable -> VSCode-linux-x64-${PV}.tar.gz )"
RESTRICT="mirror"
...
src_install()
{
	...
	cp "${S}/files/resources/app/vso.png" "${ED}/usr/share/icons/vscode.png" || die
	...
	echo "Icon=vscode" >> vscode.desktop || die
