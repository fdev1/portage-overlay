...
src_prepare() {
	...
	epatch "${FILESDIR}/${PV_MAJOR}-nameidata.patch"
	epatch "${FILESDIR}/${PV_MAJOR}-dentry.patch"
	epatch "${FILESDIR}/${PV_MAJOR}-inode.patch"
	epatch "${FILESDIR}/${PV_MAJOR}-nameidata2.patch"
	epatch "${FILESDIR}/${PV_MAJOR}-userif.patch"
	epatch "${FILESDIR}/${PV_MAJOR}-netif.patch"
	epatch "${FILESDIR}/${PV_MAJOR}-driver.patch"
	epatch "${FILESDIR}/${PV_MAJOR}-driver2.patch"
	epatch "${FILESDIR}/${PV_MAJOR}-vmci-iovec.patch"
	epatch "${FILESDIR}/${PV_MAJOR}-afvsock.patch"
	epatch "${FILESDIR}/${PV_MAJOR}-notify.patch"
	epatch "${FILESDIR}/${PV_MAJOR}-notifyQState.patch"
